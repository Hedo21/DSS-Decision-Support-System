<?php
include('../config.php');
$sql = "SELECT id_kriteria FROM kriteria";
			...
			<div class="row mt-3 justify-content-center">
				<div class="col-md-9">
					<form action="../insert/insertbobot.php" method="POST">
						<h1 class="form-label">Form Bobot</h1>
						<div class="mb-3">
							<label for="disabledSelect" class="form-label">ID Kriteria</label>
							<select name="idkret" id="disabledSelect" class="form-select">
								<?php foreach ($results as $row) : ?>
									<option><?= $row['id_kriteria']; ?></option>
								<?php endforeach; ?>
						...
						<div class="mb-3">
							...
							<input type="text" name="value" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
